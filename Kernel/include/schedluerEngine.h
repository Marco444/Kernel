...
/*
 * Definido el formato donde voy a almacenar los contextos de los diferentes
 * proyectos que van a correr, una array que en cada indice va a guardar el
 * valor de cada uno de los registro.
 */
/*
typedef struct {
